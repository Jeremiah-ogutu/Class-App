...
public class StudentSignInActivity extends AppCompatActivity  implements View .OnClickListener {
    ...
    public static final String TAG = StudentSignInActivity.class.getSimpleName();
    ...
    public void onClick(View v) {
        ...
        if(v == mLoginTextView) {
            Intent intent = new Intent(StudentSignInActivity.this,StudentSignInActivity.class);
    ...
    private void createNewStudent() {
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, task -> {
            ...
            if (task.isSuccessful()) {
                ...
                Toast.makeText(StudentSignInActivity.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(StudentSignInActivity.this, "The display name has ben set", Toast.LENGTH_LONG).show();
                        }
                    }
                });
